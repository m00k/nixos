{
  inputs = {
    nixpkgs.url = "github:NixOS/nixpkgs/nixos-25.05"; # TODO: "github:nixos/nixpkgs/nixos-unstable";
    nixos-hardware.url = "github:NixOS/nixos-hardware/master"; # TODO: "github:NixOS/nixos-hardware";
    home-manager = {
      url = "github:nix-community/home-manager/release-25.05"; # TODO: "github:nix-community/home-manager";
